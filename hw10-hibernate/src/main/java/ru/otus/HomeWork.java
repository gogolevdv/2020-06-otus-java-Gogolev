...
public class HomeWork {
    ...
    public static void main(String[] args) {
        ...
        Set<PhoneDataSet> phoneDataSet_1 = new HashSet<>();
        Set<PhoneDataSet> phoneDataSet_2 = new HashSet<>();

        PhoneDataSet ph1 = new PhoneDataSet();
        ph1.setNumber("765");
        ph1.setUser(user1);
        phoneDataSet_1.add(ph1);
        user1.setPhone(phoneDataSet_1);

        PhoneDataSet ph2 = new PhoneDataSet();
        ph2.setNumber("842");
        ph2.setUser(user2);
        phoneDataSet_2.add(ph2);
        user2.setPhone(phoneDataSet_2);
